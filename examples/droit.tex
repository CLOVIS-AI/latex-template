...
\glossaryentry{test}{test}{tests}{This is a test.}
...
\begin{tikzpicture}
\begin{class}{Test}{0,0}
\attribute{- ID: long}
\operation{+ getId(): long}
\end{class}
\end{tikzpicture}
...
\item Le droit international public (les rapports entre les États et les compétences des organisations internationales)\label{test2}\entry{personne!publique},
...
Il s'agit de regroupements de \entry{personne} personnes autour d'un intérêt commun. On en trouve deux catégories: publiques (l'État, les départements, les écoles, les hôpitaux...) et privées (entreprises et associations).
